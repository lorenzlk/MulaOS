-- Top Products by Store Clicks
-- Description: Finds product IDs with most mula_store_click events by host in past 30 days
-- Parameters: days_back (default: 30)
-- Output: host, product_id, click_count
...
GROUP BY properties['host'], properties['eventValue']
HAVING count(*) >= 1
