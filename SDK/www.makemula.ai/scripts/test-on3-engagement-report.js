...
async function testOn3EngagementReport() {
  console.log('🧪 Testing Engagement Report for on3.com (30 days)...\n');
  
  try {
    // Test with on3.com domain and 30-day lookback
    ...
    if (result.data) {
      ...
      if (data.length > 0) {
        ...
        if (mulaNotShown && mulaShown) {
          ...
          const reportMessage = formatEngagementReport('www.on3.com', 30, mulaNotShown, mulaShown);
          
          // Send to default Slack channel (you can change this to your preferred channel)
          ...
          await sendSlackMessage(defaultChannel, `🧪 Test Engagement Report: www.on3.com`, reportMessage);
...
if (require.main === module) {
  testOn3EngagementReport();
}

module.exports = { testOn3EngagementReport };
